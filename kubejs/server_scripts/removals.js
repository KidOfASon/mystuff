...
ServerEvents.recipes(event => {
    const toRemoveOutput = ['thermal:machine_furnace', 'thermal:machine_sawmill',
        ...
        'createdieselgenerators:diesel', 'createdieselgenerators:gasoline',  'ae2:charger', 'ae2:drive', 'ae2:chest', 'nuclearcraft:manganese_ingot', 'nuclearcraft:tin_ingot', 'nuclearcraft:strontium_ingot', 'nuclearcraft:calcium_ingot', 'nuclearcraft:hafnium_ingot', 'nuclearcraft:chromium_ingot', 'nuclearcraft:boron_ingot', 'nuclearcraft:hsla_steel_ingot', 'nuclearcraft:niobium_ingot', 'nuclearcraft:potassium_ingot', 'nuclearcraft:titanium_ingot', 'nuclearcraft:sodium_ingot', 'nuclearcraft:magnesium_ingot', 'nuclearcraft:yttrium_ingot', 'nuclearcraft:thorium_ingot', 'nuclearcraft:palladium_ingot', 'nuclearcraft:beryllium_ingot', 'nuclearcraft:lithium_ingot', 'nuclearcraft:graphite_ingot'
    ];
