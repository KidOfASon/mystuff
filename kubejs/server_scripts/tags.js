...
ServerEvents.tags('item', event=>{
	...
	event.removeAll(`forge:plates/${material}`);
	event.removeAll(`forge:ingot/${material}`);
	event.removeAll(`forge:ingots/${material}`);
	event.removeAll(`forge:dusts/${material}`);
	event.removeAll(`forge:plate/${material}`);
	event.add(`forge:plates/${material}`, `gtceu:${material}_plate`);
	event.add(`forge:ingot/${material}`, `gtceu:${material}_ingot`);
	event.add(`forge:ingots/${material}`, `gtceu:${material}_ingot`);
	event.add(`forge:dusts/${material}`, `gtceu:${material}_dust`);
	event.add(`forge:plate/${material}`, `gtceu:${material}_plate`);
    });

    event.add('forge:ingots/gold', 'minecraft:gold_ingot');
